...
# Huffman coding is a lossless data compression algorithm. In this algorithm, 
# a variable-length code is assigned to input different characters. 
...
# The steps are 
# 1) Probability Calculation & Ordering the Symbols
